...
def remove_capital_letters_from_string(string)
  # substitute for the matched uppercase text
  string.gsub(/\p{Upper}/, '')
end
...
def titleize_a_string(string)
  ...
  string.gsub("the l", 'The L').gsub("wi", 'Wi').gsub("wa", 'Wa')
end
...
def select_elements_starting_with_a(array)
  array.delete_if{ |item| !item.start_with?("a")}
end
...
def remove_nils_and_false_from_array(array)
  # lazy copy paste
  array.delete_if{ |item| item == nil}
  array.delete_if{ |item| item == false}
end
...
def average_of_array(array)
  array.sum.fdiv(array.size).ceil
end
...
def get_elements_until_greater_than_five(array)
  # not sure what I am meant to do here 2, 1, 3, and the first element is not greater that 5
  array.delete_if{ |item| item > 5 }.take(6)
end
